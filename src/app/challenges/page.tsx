        ...
        <div className="min-h-screen grid-background" style={{ background: 'var(--bg-primary)' }}>
            ...
            <main className="container" style={{ padding: '2rem 1.5rem' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.5rem' }}>🎯 Capture The Flag</h1>
                ...
                {/* Score Overview */}
                <div className="glass" style={{ borderRadius: '0.75rem', padding: '1.5rem', marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-around', flexWrap: 'wrap', gap: '1rem' }}>
                    <div style={{ textAlign: 'center' }}>
                        <div className="mono" style={{ fontSize: '2rem', fontWeight: 700, color: '#00ff88' }}>{earnedPoints}</div>
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Pontos Ganhos</div>
                    </div>
                    <div style={{ width: '1px', height: '40px', background: 'var(--border-primary)' }} />
                    <div style={{ textAlign: 'center' }}>
                        <div className="mono" style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text-secondary)' }}>{totalPoints}</div>
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Total Disponível</div>
                    </div>
                    <div style={{ width: '1px', height: '40px', background: 'var(--border-primary)' }} />
                    <div style={{ textAlign: 'center' }}>
                        <div className="mono" style={{ fontSize: '2rem', fontWeight: 700, color: '#00d4ff' }}>{enhancedChallenges.filter(c => c.completed).length}/{enhancedChallenges.length}</div>
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Completados</div>
                    </div>
                </div>
